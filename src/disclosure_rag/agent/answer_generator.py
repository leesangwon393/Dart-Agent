...
8. 재무제표 숫자를 인용할 때는 evidence의 Section 경로나 표 제목에 "연결"
   ...
   단정하지 마세요.
9. evidence에 적힌 숫자와 단위(원/천원/백만원/억원 등)를 그대로 옮겨 쓰세요.
   원/천원/백만원/억원 사이의 단위 환산은 암산으로 하지 마세요 — 자릿수를
   하나 잘못 옮겨 10배 틀리는 사고가 실제로 반복 확인됐습니다(예: evidence
   "28,178,420,000원"을 "281,784백만원"으로 10배 부풀려 씀). 같은 값을
   괄호로 다른 단위로 다시 풀어 쓰지 말고, evidence에 있는 표기 그대로
   한 번만 쓰세요."""
